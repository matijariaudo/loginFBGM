...
function initServer() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            app.get('/loginfacebook', passport_1.passport.authenticate("facebook"));
            app.get('/auth/:medio/redirect', function (req, res, next) {
                ...
                var _a = req.user, name = _a.name, email = _a.email, id = _a.id, medio = _a.medio;
                return res.redirect("../../?name=".concat(name, "&email=").concat(email, "&id=").concat(id, "&medio=").concat(medio));
            });
            app.get('', function (req, res) {
                return res.sendFile((0, path_1.join)(__dirname, '../public', 'index.html'));
            });
            app.listen(3000, function () { console.log("Funcionando puerto 3000"); });
            return [2 /*return*/];
        });
    });
}
